    ...
    <section className="py-9 md:py-14 relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 sm:px-6 relative">
        <div className="max-w-3xl mx-auto text-center">
          <div className="w-11 h-11 mx-auto mb-3.5 rounded-full bg-primary/10 flex items-center justify-center ring-1 ring-primary/20">
            <Moon className="w-5 h-5 text-primary" />
          </div>
          <div className="w-14 h-px bg-primary/40 mx-auto mb-4" aria-hidden="true" />
          <blockquote className="text-base md:text-xl leading-relaxed text-foreground italic font-medium">
            "And among His signs is that He created for you spouses from among yourselves,
            that you may find tranquillity in them..."
          </blockquote>
          <cite className="not-italic block text-sm text-primary font-semibold mt-3.5">
            — Surah Ar-Rum (30:21)
          </cite>
          <div className="w-14 h-px bg-primary/40 mx-auto mt-4" aria-hidden="true" />
        </div>
      </div>
