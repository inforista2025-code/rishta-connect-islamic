...
export function FAQSection() {
  const faqs = [
    ...
    { id: "3", question: "How do I login after verification?", answer: "Once your profile is verified by our team, simply go to Member Login, enter your registered WhatsApp number, and you will receive a one-time code (OTP) on your registered email. Enter the code to access your personal dashboard — no password needed." },
