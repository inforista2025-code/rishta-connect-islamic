          ...
          <div className="space-y-6 relative">
            <DialogHeader className="p-0 text-left">
              ...
              <div className="bg-gradient-to-br from-emerald-800 via-primary to-teal-900 text-white p-5 sm:p-7 rounded-xl text-center relative overflow-hidden shadow-md">
                ...
                <DialogDescription className="text-xs sm:text-sm text-emerald-100 font-medium uppercase tracking-widest mb-3">
                  Islamic Matrimonial Biodata
                </DialogDescription>
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 mb-2">
                  ...
                  <span className="inline-flex items-center px-3 py-1 rounded-full bg-white/15 backdrop-blur-md border border-white/20 text-white text-xs font-semibold">
                    Profile ID: #{profileCode}
                  </span>
                ...
                <DialogTitle className="text-2xl sm:text-3xl font-bold tracking-tight text-white mt-2">
                  {profile.name}
                </DialogTitle>
            ...
            {/* Modal Action Footer */}
            <div className="bg-muted/60 p-4 sm:p-5 rounded-xl border flex flex-col sm:flex-row gap-3 items-center justify-between">
