    ...
    <div className="relative w-full aspect-square bg-muted overflow-hidden">
      ...
      {!viewerIsPremium && (
        <>
          ...
          <span className="absolute bottom-2 left-2 inline-flex items-center gap-1 rounded-full bg-background/90 px-2 py-0.5 text-[10px] font-semibold text-primary shadow-sm backdrop-blur-sm">
            <Lock className="w-3 h-3" /> Premium Unlock
          </span>
        </>
      )}
      {verified && (
        <span className="absolute top-2 right-2 inline-flex items-center gap-1 rounded-full bg-sage px-2 py-0.5 text-[10px] font-semibold text-primary-foreground shadow-sm backdrop-blur-sm">
